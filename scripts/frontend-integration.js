 ...
 * This file demonstrates how to integrate Irissway with a web frontend
 */

// For React/Vue/Angular applications
export class IrisswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new IrisswayClient(provider, contractAddress);
